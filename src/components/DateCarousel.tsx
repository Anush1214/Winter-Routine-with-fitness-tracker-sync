...
export const DateCarousel: React.FC<DateCarouselProps> = ({
  ...
  // Generate list of all 122 dates (Sept 1 to Dec 31)
  ...
  // Center the selected date in the scroll container
  useEffect(() => {
  ...
  const handleTodayClick = () => {
    if (allDates.includes(todayStr)) {
      ...
      // Default to Sept 1 if current time is before Sept 1
  ...
  return (
    <div className="w-full mb-6 glass-panel rounded-2xl p-3 sm:p-4 shadow-lg border border-slate-800">
      ...
      {/* Horizontal Date Scroller Strip */}
      <div
        ref={scrollRef}

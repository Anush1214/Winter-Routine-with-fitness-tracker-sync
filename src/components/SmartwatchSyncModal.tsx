  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div className="w-full max-w-2xl glass-panel rounded-2xl p-5 sm:p-6 border border-slate-700 shadow-2xl bg-slate-950/95 relative max-h-[90vh] overflow-y-auto">
        ...
        {/* Webhook & Phone Automation Instructions */}
        <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-3">
          ...
          <div className="space-y-2 text-xs text-slate-300">
            <p>
              You can send data from your <strong>CMF Watch Pro 2</strong> via the CMF Watch App, Apple Health / Google Health Connect, and an iOS Shortcut or Tasker automation that runs daily at 10 PM.
            </p>
